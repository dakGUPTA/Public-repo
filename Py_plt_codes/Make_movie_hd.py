...
if (plotting == 1):
    ...
    #felas_calc = int(input("enter 1 for calc felas or 0 for taking from prof file:")) 
    ...
    while step>-1 and step<(numsteps+1):
        ...
        if (nph == 4):
            ...
            if (df_plots == 1):
                ...
                plt.colorbar()
                plt.savefig(f'{filedir5}/dfdc_{step}.png',bbox_inches='tight',dpi=pp)

                plt.close()
                plt.imshow(dfdphi,origin='lower',cmap='jet')
                plt.colorbar()
                plt.savefig(f'{filedir6}/dfdphi_{step}.png',bbox_inches='tight',dpi=pp)

                plt.close()
                plt.imshow(dfeldphi,origin='lower',cmap='jet')
                plt.colorbar()
                plt.savefig(f'{filedir7}/dfeldphi_{step}.png',bbox_inches='tight',dpi=pp)
            ...
            if (elas == 1):
                if (sts_plots == 1):
                    ...
                    plt.colorbar()
                    plt.savefig(f"{filedir8}/S11_{step}",bbox_inches='tight',dpi=pp)
                     
                    plt.close()
                    plt.imshow(s22,origin='lower',cmap = 'jet')
                    plt.colorbar()
                    plt.savefig(f"{filedir9}/S22_{step}",bbox_inches='tight',dpi=pp)
                    
                    plt.close()
                    plt.imshow(s12,origin='lower',cmap='jet')
                    #plt.gca().invert_yaxis()
                    plt.colorbar()
                    plt.savefig(f"{filedir10}/S12_{step}",bbox_inches='tight',dpi=pp)
                    ...
                    if (Z_comp == 1):
                        ...
                        plt.colorbar()
                        plt.savefig(f"{filedir11}/S33_{step}",bbox_inches='tight',dpi=pp)

                    plt.close()#
                    plt.imshow(Hsts,origin='lower',cmap = 'jet')
                    plt.colorbar()
                    plt.savefig(f"{filedir12}/Hsts_{step}",bbox_inches='tight',dpi=pp)
                ...
                if (str_plots == 1):
                    ...
                    plt.colorbar()
                    plt.savefig(f"{filedir13}/E11_{step}",bbox_inches='tight',dpi=pp)

                    plt.close()
                    plt.imshow(e22,origin='lower',cmap = 'jet')
                    plt.colorbar()
                    plt.savefig(f"{filedir14}/E22_{step}",bbox_inches='tight',dpi=pp)
                    
                    plt.close()
                    plt.imshow(e12,origin='lower',cmap = 'jet')
                    plt.colorbar()
                    plt.savefig(f"{filedir15}/E12_{step}",bbox_inches='tight',dpi=pp)
                    
                    if (Z_comp == 1):
                        plt.close()
                        plt.imshow(e33,origin='lower',cmap = 'jet')
                        plt.colorbar()
                        plt.savefig(f"{filedir16}/E33_{step}",bbox_inches='tight',dpi=pp)

                    plt.close()
                    plt.imshow(Hstr,origin='lower',cmap = 'jet')
                    plt.colorbar()
                    plt.savefig(f"{filedir17}/Hstr_{step}",bbox_inches='tight',dpi=pp)
                ...
                if (felas_plots == 1):
                    ...
                    plt.colorbar()
                    plt.savefig(f"{filedir18}/felas_{step}",bbox_inches='tight',dpi=pp)
            ...
            if (ftotal_plots == 1):
                ...
                plt.colorbar()
                plt.savefig(f"{filedir19}/ftotal_{step}",bbox_inches='tight',dpi=pp)
        ...
        if (phi_comp_plots == 1):
            ...
            plt.colorbar()
            plt.savefig(f'{filedir2}/comp_{step}.png',bbox_inches='tight',dpi=pp)
